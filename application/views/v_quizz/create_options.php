...
<div>
	...
	<form method="post" class="marge"
		action="<?php echo base_url()?>	quizz/new_quizz">
		...
		<div class="form-group" style="margin-left: 40px;">
			...
			<div class="col-xs-12" style="height: 100px; margin-bottom: 40px;">
				...
				<input class="form-control col-md-3 " placeholder="Nom du Quizz ?"
					name="nomquizz" style="max-width: 250px;">
			...
			<div class="col-xs-12" style="margin-bottom: 20px;" name="1ereligne">
				...
				<div class="col-xs-6">
					...
					<div class="radio">
						<label> <input type="radio" name="affichage_questions" value="0"
							checked="">Non
						</label>
					</div>
					<div class="radio">
						<label> <input type="radio" name="affichage_questions" value="1">Oui
						</label>
					</div>
				</div>
			</div>
			...
			<div class="col-xs-12" style="margin-bottom: 20px;">
				...
				<div class="col-xs-6">
					...
					<div class="radio">
						<label> <input type="radio" name="affichage_resultats" value="0"
							checked="">Non
						</label>
					</div>
					<div class="radio">
						<label> <input type="radio" name="affichage_resultats" value="1">Oui
						</label>
					</div>
				</div>
			</div>
			...
			<div class="col-xs-12" style="margin-bottom: 20px;">
				<div class="col-xs-6 ">
					<button class="btn btn-default btn-lg  pull-left col-xs-12"
						type="submit" name="" style="max-width: 300px;">Envoyer</button>
				</div>
				<div class="col-xs-6">
