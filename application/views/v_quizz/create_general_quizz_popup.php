...
$(document).ready(function(){
	...
	$("#ajout_champ").click(function(){
		$(".cloneur").clone(true).insertBefore("#ajout_champ");
});
</script>
<!-- Modal -->
<div class="modal fade" id="myModal_general_quizz" tabindex="-1"
	role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
	<div class="modal-dialog">
		<div class="modal-content col-xs-8	col-xs-offset-2"
			style="margin-top: 50px">
			<div class="modal-header">
				<button type="button" id="ajout_question" class="close"
			...
			<div class="modal-body">
				<form method="post" action="">
					...
					<button class="btn btn-primary" id="ajout_champ">Ajout</button>
			</div>
